...
const inputClass =
  "w-full rounded-md border border-hairline bg-surface px-3 py-2 text-sm text-fg outline-none focus:border-silver-lo";
const labelClass = "mb-1 block text-[10px] tracking-wide text-fg-muted uppercase";
  ...
  return (
    <form action={formAction} className="max-w-2xl space-y-6">
      ...
      {instrumentType === "OPTION" && (
        <div className="grid grid-cols-3 gap-4 rounded-md border border-hairline bg-surface p-4">
          <div>
